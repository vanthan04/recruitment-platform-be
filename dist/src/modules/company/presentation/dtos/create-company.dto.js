...
const company_size_vo_1 = require("../../domain/value-objects/company-size.vo");
...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ example: 'We build great software.' }),
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.IsOptional)(),
    __metadata("design:type", String)
], CreateCompanyDto.prototype, "description", void 0);
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ example: 'https://techcorp.com' }),
    (0, class_validator_1.IsUrl)(),
    (0, class_validator_1.IsOptional)(),
    __metadata("design:type", String)
...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ enum: company_size_vo_1.CompanySize }),
    (0, class_validator_1.IsEnum)(company_size_vo_1.CompanySize),
    (0, class_validator_1.IsOptional)(),
    __metadata("design:type", String)
], CreateCompanyDto.prototype, "size", void 0);
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ example: 'Ho Chi Minh City' }),
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.IsOptional)(),
