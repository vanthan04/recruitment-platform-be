...
export declare class JobController {
    ...
    private readonly closeJobUseCase;
    private readonly reopenJobUseCase;
    constructor(createJobUseCase: CreateJobUseCase, updateJobUseCase: UpdateJobUseCase, listJobsUseCase: ListJobsUseCase, getJobUseCase: GetJobUseCase, deleteJobUseCase: DeleteJobUseCase, closeJobUseCase: CloseJobUseCase, reopenJobUseCase: ReopenJobUseCase);
    ...
    close(recruiterId: string, jobId: string): Promise<import("../../../../common/dtos/response.dto").ResponseDto<import("../../application/dto/job-response.dto").JobResponseDto>>;
    reopen(recruiterId: string, jobId: string): Promise<import("../../../../common/dtos/response.dto").ResponseDto<import("../../application/dto/job-response.dto").JobResponseDto>>;
}
