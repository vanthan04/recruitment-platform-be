...
let GetCvUseCase = class GetCvUseCase {
    cvRepository;
    ...
    async execute(cvId) {
        ...
        return cv_response_mapper_1.CvResponseMapper.toDto(cv);
    }
};
exports.GetCvUseCase = GetCvUseCase;
exports.GetCvUseCase = GetCvUseCase = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [cv_repository_1.ICvRepository])
], GetCvUseCase);
//# sourceMappingURL=get-cv.use-case.js.map