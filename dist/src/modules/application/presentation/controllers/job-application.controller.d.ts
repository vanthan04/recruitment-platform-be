...
export declare class JobApplicationController {
    ...
    private readonly getJobStatsUseCase;
    constructor(applyJobUseCase: ApplyJobUseCase, updateStatusUseCase: UpdateApplicationStatusUseCase, listMyAppsUseCase: ListMyApplicationsUseCase, listByJobUseCase: ListApplicationsByJobUseCase, withdrawApplicationUseCase: WithdrawApplicationUseCase, getJobStatsUseCase: GetJobStatsUseCase);
    ...
    getJobStats(recruiterId: string, jobId: string): Promise<import("../../../../common/dtos/response.dto").ResponseDto<import("../../application/dto/job-stats-response.dto").JobStatsResponseDto>>;
    withdraw(userId: string, id: string): Promise<import("../../../../common/dtos/response.dto").ResponseDto<import("../../application/dto/application-response.dto").ApplicationResponseDto>>;
