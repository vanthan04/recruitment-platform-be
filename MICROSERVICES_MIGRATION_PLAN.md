...
>
> **Cập nhật 2026-09-03**: Phase 1 (CQRS hoá bên trong monolith, mục 8 bên dưới) **đã xong** — toàn bộ 16 module business đã dùng `Command`/`Query` + `Handler` qua `@nestjs/cqrs`, không còn use-case class kiểu cũ (xem [CODEBASE_SUMMARY.md](CODEBASE_SUMMARY.md) mục 2).
>
